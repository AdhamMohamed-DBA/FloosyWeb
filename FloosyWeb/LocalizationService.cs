    ...
    public string T(string key)
    {
        if (!IsArabic)
        {
            return key switch
            {
                ...
                "NoCreditCardsYet" => "No credit cards yet.",
                ...
                "CardName" => "Card Name",
                "CurrentOwedOptional" => "Current owed (optional)",
                "DeleteCreditCardQuestion" => "Delete credit card?",
                "CreditOutUseCard" => "Credit Out (use card)",
                "CreditInPayCard" => "Credit In (pay card)",
                "TransferAccountCredit" => "Transfer account ↔ credit",
                "CreditExpense" => "Credit Expense",
                "CreditPayment" => "Credit Payment",
                "CreditTransfer" => "Credit Transfer",
                "CreditAdjustment" => "Credit Adjustment",
                "BillPaidByCredit" => "Bill Paid by Credit",
                "PaySource" => "Pay Source",
                "PayFromAccount" => "Pay from account",
                "Category" => "Category",
                "DueDate" => "Due Date",
                "DebtsView" => "Debts view",
                "LiveDebts" => "Live Debts",
        ...
        return key switch
        {
            ...
            "NoCreditCardsYet" => "لا توجد بطاقات ائتمان بعد.",
            "CreditCard" => "بطاقة ائتمان",
            "CreditLimit" => "الحد الائتماني",
            "Outstanding" => "المستحق",
            "AvailableCredit" => "المتاح",
            "StatementDay" => "يوم كشف الحساب",
            "GraceDays" => "أيام السماح",
            "NextDue" => "موعد السداد القادم",
            "PaySoon" => "ادفع قريبًا",
            "NewCreditCard" => "بطاقة ائتمان جديدة",
            "EditCreditCard" => "تعديل بطاقة الائتمان",
            "CardName" => "اسم البطاقة",
            "CurrentOwedOptional" => "المبلغ الحالي عليك (اختياري)",
            "DeleteCreditCardQuestion" => "حذف بطاقة الائتمان؟",
            "CreditOutUseCard" => "مصروف ائتمان (استخدام البطاقة)",
            "CreditInPayCard" => "سداد ائتمان",
            "TransferAccountCredit" => "تحويل حساب ↔ ائتمان",
            "CreditExpense" => "مصروف ائتمان",
            "CreditPayment" => "سداد ائتمان",
            "CreditTransfer" => "تحويل ائتمان",
            "CreditAdjustment" => "تسوية ائتمان",
            "BillPaidByCredit" => "فاتورة مدفوعة بالائتمان",
            "PaySource" => "مصدر الدفع",
            "PayFromAccount" => "ادفع من الحساب",
            "Category" => "التصنيف",
            "DueDate" => "تاريخ الاستحقاق",
            "DebtsView" => "عرض الديون",
            "LiveDebts" => "ديون قائمة",
            "SettledDebts" => "ديون مسوّاة",
            "AllDebts" => "كل الديون",
